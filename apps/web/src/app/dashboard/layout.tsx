  ...
  return (
    ...
    <div className="min-h-screen bg-background">
      ...
      {showShortcuts && (
        ...
        >
          <div
            className="glass-modal vibrancy rounded-2xl w-full max-w-md max-h-[70vh] flex flex-col animate-scale-in"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b flex-shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-rose-500 flex items-center justify-center">
                  <Keyboard className="w-4 h-4 text-white" />
                </div>
                <h3 className="text-lg font-bold">{t('keyboard.title')}</h3>
              </div>
              <button
                onClick={() => setShowShortcuts(false)}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              <div>
                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('keyboard.general')}</h4>
              ...
              <div>
                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('nav.ideas')}</h4>
                <div className="space-y-1">
                  <ShortcutRow keys={['N']} description={t('keyboard.newIdea')} />
                  <ShortcutRow keys={['J']} description={t('keyboard.moveDown')} />
                  <ShortcutRow keys={['K']} description={t('keyboard.moveUp')} />
                  <ShortcutRow keys={['Enter']} description={t('keyboard.editIdea')} />
                  <ShortcutRow keys={['Space']} description={t('keyboard.selectIdea')} />
                  <ShortcutRow keys={['G']} description={t('keyboard.goToEnd')} />
                  <ShortcutRow keys={['X']} description={t('keyboard.deleteIdea')} />
                </div>
              </div>

              <div>
                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('nav.videos')}</h4>
                <div className="space-y-1">
              ...
              <div>
                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('nav.calendar')}</h4>
                <div className="space-y-1">
      ...
      <div className="flex items-center gap-0.5">
        {keys.map((key, index) => (
          <span key={index} className="flex items-center">
            <kbd className="px-1.5 py-0.5 rounded bg-muted text-xs font-mono font-medium min-w-[22px] text-center inline-block">
              {key}
            </kbd>
